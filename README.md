...
Efficient data fetching & caching via TanStack React Query

Form handling and validation with React Hook Form

Star ratings & reviews using React Rating

Carousels and sliders powered by Swiper

Toasts and alerts using React Toastify & SweetAlert2
...
Tab-based content using React Tabs

Scrolling highlights with React Fast Marquee

🚀 Tech Stack

LocalChefBazaar is built using modern and scalable technologies:
